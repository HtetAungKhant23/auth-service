...
@Module({
  ...
  providers: [
    ...
    /** used custom provider (factory provider) => [provide can use any name you like] / [inject is come from provide of value provider , and useFactory(callback function) take optional argument that is come from useValue key of value provider ]  */
    {
